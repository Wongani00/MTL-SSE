      ...
      <div class="relative mx-auto w-full max-w-md bg-white px-6 pt-10 pb-8 mt-4 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
        <div class="w-full">
          <div class="flex flex-col items-center justify-center">
            ...
            <h1 class="text-2xl font-md text-gray-900">Sign in</h1>
          </div>
          <div class="mt-8">
            <form action="">
              ...
              <div class="my-6">
                <button
                  type="submit"
                  class="w-full rounded-md bg-[midnightblue] px-3 py-2 text-white cursor-pointer duration-200 transition hover:font-semibold hover:scale-101 focus:bg-gray-600 focus:outline-none"
                >
                  Sign in
                </button>
              </div>
